...
void SpriteManager::init() {
    ...
    std::unordered_map<std::string, std::string> spriteMappings = {
        ...
        {"paw", "./assets/icons/paw.png"},
        {"cells", "./assets/icons/cells.png"},
        {"brain", "./assets/icons/brain.png"},
        {"thermometer", "./assets/icons/thermometer.png"},
        {"geneRegulatoryNetwork", "./assets/icons/gene-regulatory-network.png"},
        {"copy", "./assets/icons/copy.png"},
        {"copyHighlighted", "./assets/icons/copy_highlighted.png"},
